...
{: align="center"}
![研究概要](/assets/images/research_overview1.png)  

{: align="center"}
![研究概要](/assets/images/research_overview2.jpg)  
...
## 修士研究テーマ
### 2025年度修士研究テーマ
* コストと精度を考慮した質問と文書の特徴に基づく適応的なRAG選択手法
* 視覚言語モデルを用いた日常生活動画からのイベント中心知識グラフ生成
...
### 2025年度卒業研究テーマ
* BOLD信号の予測における、物語内容および個人差に対する言語モデルの感度分析
* 皮質-基底核結合分析における多様なデータセットを対象としたパイプラインの最適化
* 視覚情報の有無による脳活動の比較解析
* 検索拡張生成に基づくBIDSデータセット検索システム
* 大規模言語モデルを用いた対話からのユーザ嗜好を考慮した知識獲得
* 判決文における伏字箇所を対象とした固有表現カテゴリ分類および実体同定に基づく代替符号置換
* 大規模言語モデルに基づく判決・裁決文の概要生成
* 裁決文を対象とした大規模言語モデルの埋め込み表現に基づくセマンティック検索システム
* 大規模言語モデルを用いたオントロジーにおける概念間の関係抽出
* Wikidataの編集履歴に基づくプロパティ不変性の定量化
* Wikidataを対象としたメンション補助情報と検索拡張生成に基づくエンティティリンキング
* 大規模言語モデルを用いた議論文における誤謬種別分類および誤謬箇所同定
* 視覚言語モデルに基づく対話型動画質問応答における自己反省と常識知識グラフを用いた回答の説明可能性向上
* 大規模言語モデルを用いたDBpediaの知識グラフ補完
* 視覚言語モデルを用いた動作認識データセットの拡張
